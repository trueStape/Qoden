...
namespace WebApp
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            var usedId = HttpContext.User.Claims.FirstOrDefault(x => x.Type == ClaimTypes.NameIdentifier)?.Value;
            
            return _accountService.LoadOrCreateAsync(usedId /* TODO 3: Get user id from cookie */);
        }
